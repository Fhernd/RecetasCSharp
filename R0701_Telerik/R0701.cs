...
{
    public partial class R0701 : Telerik.WinControls.UI.RadForm
    {
        public R0701()
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            foreach (string app in dotNet)
            {
                ...
                radCheckBox.Top = posicionHorizontal;
                radCheckBox.Left = 10;
                radCheckBox.Text = app;
                ...
                pnlRadContenedor.Controls.Add(radCheckBox);
            }
